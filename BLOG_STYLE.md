...
*   **Active Link Verification:** Before finalizing or publishing a post, you MUST explicitly verify that all URLs in the References section are active and return a successful HTTP status (e.g., 200 OK). Any dead links (e.g., 404 Not Found) must be updated to current URLs or archived versions.
