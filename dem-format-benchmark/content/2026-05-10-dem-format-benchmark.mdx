...
You've got a Copernicus 30m DEM covering a 6°×6° region — roughly 466.6M pixels and 11.7GB uncompressed. You're on a MacBook Air with 8GB of RAM. How do you actually query this thing?
...
|--------|------|
| COG | 1749.6 MB |
| Parquet (flat) | 1889.2 MB |
| Parquet + S2 | 2238.9 MB |
| Parquet + H3 | 3064.7 MB |
| GeoParquet | 2994.6 MB |
...
- **Winner:** COG + Rasterio — median 119.7ms, 130.7MB peak

- **Winner:** COG + rioxarray — median 183.1ms, 143.4MB peak

- **Winner:** Parquet + S2 + Polars — median 310.6ms, 181.6MB peak
